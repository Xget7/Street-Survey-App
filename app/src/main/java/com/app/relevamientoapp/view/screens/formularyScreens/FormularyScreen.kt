...
import com.app.relevamientoapp.view.viewmodels.formularies.FormularyScreenViewModel
...
fun FormularyScreen(
    ...
    viewModel: FormularyScreenViewModel = hiltViewModel()
) {
        ...
        Column(
            ...
            if (openDialog.value) {
                ...
                AlertDialog(
                    ...
                    title = {
                        Text(
                            text = "Finalizacion de informes peatonales",
                            fontWeight = FontWeight.Bold,
                            fontSize = 16.sp
                        )
                    },
                        ...
                        TextButton(
                            onClick = {
                                ...
                                navController.navigate(
                                    Destinations.ComplementaryFormularySelectionScreen.passSurveyId(
